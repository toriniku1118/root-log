...
- 差別化の核:相手の育て方(記録・来歴)を見て、売買・交換・相談ができること。誰でも出品できて、出品に記録は必須ではない。記録は信頼を上げる表示(2026-09-26。以前の「記録を公開している人だけが取引できる」は廃止)。記録する植物と、売買・交換する物(植物・資材)は、対応させなくてよい。来歴つきの記録は、品種偽装・写真の使い回しへの対策になる。
...
| 5 売買・交換 | 誰でも出品できる(記録は必須でなく、信頼を上げる表示)、出品者の記録・来歴の表示、レスキュー株区分、決済代行 | |
