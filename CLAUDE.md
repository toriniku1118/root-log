...
- 目標:副業として年20万円の利益(2年目までが現実的な目標)。収益の柱は有料プラン(月480円。記録をカップル・夫婦・家族で共有して一緒に管理できる/植物の登録数の上限なし/広告非表示。高画質と入荷通知の拡大は有料にしない=2026-09-26。中身は再検討中)と取引(手数料5%・出品オプション1回200円)。広告は補助。取引がアプリ外で成立するのは仕方がない(他の売買サービスも同じ)前提で、手数料はアプリ内で成立した分だけで見積もる。相談Q&Aはすべて無料(将来、ベストアンサー率に応じたポイントをイベントで使える形を検討)。
...
- セキュリティ要件の「フェーズ」は旧呼び方。対応:フェーズ1=ステップ1、1.5=ステップ4(同居人共有・課金)、2a=ステップ3、2a+=ステップ4(入荷通知・相談)、2b=ステップ5。
...
| 2 入荷情報・イベント・相談 | 入荷情報(顧客同士の投稿が主・無料の入荷通知)・イベント情報の掲載(無料。生成AIで収集し、確度の高い情報だけ)、イベント通知、相談Q&A(無料。AI一次回答は回数上限つき。ステップ6から前倒し・時期は案)、広告。6か月目ごろストア公開 | |
| 3 記録を見せ合う | 公開プロフィール、来歴の閲覧、品種ページ、反応 | |
| 4 有料プラン | 記録の共有、登録数の上限なし、広告非表示(中身は再検討中。入荷通知の拡大・高画質は有料にしない) | |
