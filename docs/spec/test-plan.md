...
| 対象 | コマンド | 結果 |
|---|---|---|
| Flutter(単体・ウィジェット) | `docker compose run --rm flutter bash -c "flutter pub get && flutter test"` | 70件合格(`plant_repository_test` 12、`plant_genre_test` 5、`plant_health_test` 3、`plant_input_test` 27、`plant_rules_consistency_test` 11、`plant_groups_test` 4、`home_screen_test` 8)。`flutter analyze` も問題なし(2026-09-26、#58) |
